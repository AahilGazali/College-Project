...
import { Eye, EyeOff, Mail, Lock, User, AlertCircle, Brain } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="block w-full pl-4 pr-10 py-3 text-base border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-lg shadow-sm"
              >
